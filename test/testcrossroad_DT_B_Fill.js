...
contract("TestCrossroad_PostDepositBnbPayFee_FillBnbPartial1", accounts => {
  ...
  it("should post deposit token", async () => {
    ...
    assertEqBigInt(fillerBnbAmount,initFillerBnbAmount-fillAmountOut-(fillGasUsed)*gasPrice, "Mismatch: fillerBnbAmount");
...
contract("TestCrossroad_PostDepositBnbPayFee_FillBnbPartial2", accounts => {
  ...
  it("should post deposit token", async () => {
    ...
    assertEqBigInt(filler1BnbAmount,initFiller1BnbAmount-fillAmountOut1-(fill1GasUsed)*gasPrice, "Mismatch: filler1BnbAmount");
    assertEqBigInt(filler2BnbAmount,initFiller2BnbAmount-fillAmountOut2-(fill2GasUsed)*gasPrice, "Mismatch: filler2BnbAmount");
    assertEqBigInt(crossroadBnbAmount,0n, "Mismatch: crossroadBnbAmount");
...
contract("TestCrossroad_PostDepositBnbPayFee_FillBnbAll1", accounts => {
  ...
  it("should post deposit token", async () => {
    ...
    assertEqBigInt(fillerBnbAmount,initFillerBnbAmount-inputAmountOut-(fillGasUsed)*gasPrice, "Mismatch: fillerBnbAmount");
    assertEqBigInt(crossroadBnbAmount,0n, "Mismatch: crossroadBnbAmount");
...
contract("TestCrossroad_PostDepositBnbPayFee_FillBnbAll2", accounts => {
  ...
  it("should post deposit token", async () => {
    ...
    assertEqBigInt(filler1BnbAmount,initFiller1BnbAmount-fillAmountOut1-(fill1GasUsed)*gasPrice, "Mismatch: filler1BnbAmount");
    assertEqBigInt(filler2BnbAmount,initFiller2BnbAmount-fillAmountOut2-(fill2GasUsed)*gasPrice, "Mismatch: filler2BnbAmount");
    assertEqBigInt(filler3BnbAmount,initFiller3BnbAmount-fillAmountOut3-(fill3GasUsed)*gasPrice, "Mismatch: filler3BnbAmount");
    assertEqBigInt(crossroadBnbAmount,0n, "Mismatch: crossroadBnbAmount");
