...
contract("TestCrossroad_PostDepositTokenPayFee_Fill1", accounts => {
  let feeToken;
  let feeAutoBuyer;
...
contract("TestCrossroad_PostDepositTokenPayFee_Fill2", accounts => {
  let feeToken;
  let feeAutoBuyer;
...
contract("TestCrossroad_PostDepositTokenPayFee_FillAll1", accounts => {
  let feeToken;
  let feeAutoBuyer;
...
contract("TestCrossroad_PostDepositTokenPayFee_FillAll2", accounts => {
  let feeToken;
  let feeAutoBuyer;
