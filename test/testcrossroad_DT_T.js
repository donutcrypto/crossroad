...
contract("TestCrossroad_PostDepositTokenPayFee", accounts => {
  let feeToken;
  let feeAutoBuyer;
  ...
  it("should post deposit token", async () => {
    ...
    assertEqBigInt(crossroadBalanceA_, inputAmountIn, "Mismatch: crossroadBalanceA");
...
contract("TestCrossroad_PostDepositTokenBuyFee", accounts => {
  let feeToken;
  let feeAutoBuyer;
...
contract("TestCrossroad_PostDepositTokenPayFee_Renew", accounts => {
  let feeToken;
  let feeAutoBuyer;
...
contract("TestCrossroad_PostDepositTokenPayFee_Cancel", accounts => {
  let feeToken;
  let feeAutoBuyer;
