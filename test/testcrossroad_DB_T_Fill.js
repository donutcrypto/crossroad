...
contract("TestCrossroad_PostDepositBnbPayFee_FillPartial1", accounts => {
  let feeToken;
  let feeAutoBuyer;
  ...
  it("should post deposit bnb", async () => {
    now = getCurrentTime();
    ...
    assertEqBigInt(posterBnbAmount,initPosterBnbAmount-feeAmount-inputAmountReward-inputAmountIn-(feeGasUsed+postGasUsed)*gasPrice, "Mismatch: posterBnbAmount");
    assertEqBigInt(fillerBnbAmount,initFillerBnbAmount+inputAmountIn*25n/100n-(fillGasUsed)*gasPrice, "Mismatch: fillerBnbAmount");
    assertEqBigInt(crossroadBnbAmount,inputAmountIn*75n/100n, "Mismatch: crossroadBnbAmount");
...
contract("TestCrossroad_PostDepositBnbPayFee_FillPartial2", accounts => {
  let feeToken;
  let feeAutoBuyer;
  ...
  it("should post deposit bnb", async () => {
    ...
    const crossroadBnbAmount = BigInt(await web3.eth.getBalance(crossroad.address));
    assertEqBigInt(posterBnbAmount,initPosterBnbAmount-feeAmount-inputAmountReward-inputAmountIn-(feeGasUsed+postGasUsed)*gasPrice, "Mismatch: posterBnbAmount");
    assertEqBigInt(filler1BnbAmount,initFiller1BnbAmount+inputAmountIn*25n/100n-(fill1GasUsed)*gasPrice, "Mismatch: filler1BnbAmount");
    assertEqBigInt(filler2BnbAmount,initFiller2BnbAmount+inputAmountIn*40n/100n-(fill2GasUsed)*gasPrice, "Mismatch: filler2BnbAmount");
    assertEqBigInt(crossroadBnbAmount,inputAmountIn*35n/100n, "Mismatch: crossroadBnbAmount");
...
contract("TestCrossroad_PostDepositBnbPayFee_FillAll1", accounts => {
  let feeToken;
  let feeAutoBuyer;
  ...
  it("should post deposit bnb", async () => {
    ...
    const crossroadBnbAmount = BigInt(await web3.eth.getBalance(crossroad.address));
    assertEqBigInt(posterBnbAmount,initPosterBnbAmount-feeAmount-inputAmountReward-inputAmountIn-(feeGasUsed+postGasUsed)*gasPrice, "Mismatch: posterBnbAmount");
    assertEqBigInt(fillerBnbAmount,initFillerBnbAmount+inputAmountIn*100n/100n-(fillGasUsed)*gasPrice, "Mismatch: fillerBnbAmount");
    assertEqBigInt(crossroadBnbAmount,inputAmountIn*0n/100n, "Mismatch: crossroadBnbAmount");
...
contract("TestCrossroad_PostDepositBnbPayFee_FillAll2", accounts => {
  let feeToken;
  let feeAutoBuyer;
  ...
  it("should post deposit bnb", async () => {
    ...
    assertEqBigInt(filler1BnbAmount,initFiller1BnbAmount+inputAmountIn*25n/100n-(fill1GasUsed)*gasPrice, "Mismatch: filler1BnbAmount");
    assertEqBigInt(filler2BnbAmount,initFiller2BnbAmount+inputAmountIn*40n/100n-(fill2GasUsed)*gasPrice, "Mismatch: filler2BnbAmount");
    assertEqBigInt(filler3BnbAmount,initFiller3BnbAmount+inputAmountIn*35n/100n-(fill3GasUsed)*gasPrice, "Mismatch: filler3BnbAmount");
