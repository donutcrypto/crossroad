...
contract("TestCrossroad_PostWithdrawBnbPayFee_FillBnbPartial1", accounts => {
  let feeToken;
  let feeAutoBuyer;
...
contract("TestCrossroad_PostWithdrawBnbPayFee_FillBnbPartial2", accounts => {
  let feeToken;
  let feeAutoBuyer;
...
contract("TestCrossroad_PostWithdrawBnbPayFee_FillBnbAll1", accounts => {
  let feeToken;
  let feeAutoBuyer;
...
contract("TestCrossroad_PostWithdrawBnbPayFee_FillBnbAll2", accounts => {
  let feeToken;
  let feeAutoBuyer;
